class Control9B extends HTMLElement {
    ...
    createUi() {
        ...
        this.ele.append(this.createButton('f'));
    ...
    createButton(label) {
        ...
        const listOfOffsetDownButtons = ['l','r'];
        const listOfOffsetUpButtons = ['u', 'f', 'd'];
    ...
    keyStateChange = () => {
        ...
        console.log('publishing', this.currentState);
...
customElements.define('control-9button', Control9B);