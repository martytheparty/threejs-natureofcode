( () => {
    ...
    const view = {
        createMainView: (mesh, sphereMesh, goalMesh, goal1Mesh) => {
        ...
        createFrontView: (mesh, sphereMesh, goalMesh, goal1Mesh) => {
        ...
        createLeftView: (mesh, sphereMesh, goalMesh, goal1Mesh) => {
        ...
        createBallView: (mesh, sphereMesh, goalMesh, goal1Mesh) => {
        ...
        createViews: (meshDescription, sphereMeshDescription, goalMeshDescription, goal1MeshDescription) => {
            ...
            const views = [];
            views.push(view.createMainView(plaformMeshes[0], sphereMeshes[0], goalMeshes[0], goal1Meshes[0]));
            views.push(view.createFrontView(plaformMeshes[1], sphereMeshes[1], goalMeshes[1], goal1Meshes[1]));
            views.push(view.createLeftView(plaformMeshes[2], sphereMeshes[2], goalMeshes[2], goal1Meshes[2]));
            views.push(view.createBallView(plaformMeshes[3], sphereMeshes[3], goalMeshes[3], goal1Meshes[3]));
            return views;
        }
    }
    const physics = {
    ...
    function setView() {
        ...
        floor.layers = view.createViews(meshDescription, sphereMeshDescription, goalMeshDescription, goal1MeshDescription);
    }
