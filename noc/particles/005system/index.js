...
const addBall = () => {
  ...
  let ball = pSystem.addParticle(radius, spherePosition);
...
function setup() {
    ...
    let currentBall = pSystem.getParticles()[0];
