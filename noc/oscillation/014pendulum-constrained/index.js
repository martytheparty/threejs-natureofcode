let camera, scene, renderer, geometry, material, mesh, origin, originMesh, bobBall, bobBallMesh, radius = 80, group, velocity = 0.1;
let framerate = 60;
...
const updateSceneData = () => {
  try {
    ...
    if (Math.PI/2 < Math.abs(group.rotation.z)) {
      velocity = velocity*-1;
    }
